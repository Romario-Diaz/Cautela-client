...
class DesmobilizationService {
    getAllDesmobilizations() {
        return axios.get(`${API.URI}/getAllDesmobilizations`, { headers: authHeader() })
    }
    ...
    sendDocumentToOfficers(name, perfil, idDesmo) {
        return axios.post(`${API.URI}/sendDocumentToOfficers`, { name: name, perfil: perfil, idDesmo: idDesmo }, { headers: authHeader() })
    }
